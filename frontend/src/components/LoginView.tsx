      ...
      <div className="w-full max-w-[420px] z-10 relative">
        ...
        <div className="p-[1px] rounded-3xl bg-gradient-to-b from-blue-500/30 via-purple-500/20 to-slate-200/40 dark:to-slate-800/40 shadow-2xl">
          ...
          <div className="w-full bg-white/90 dark:bg-slate-900/85 backdrop-blur-2xl border border-slate-200/80 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
            ...
            {isSuccess && (
              <div className="absolute inset-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md z-30 flex flex-col items-center justify-center p-6 text-center space-y-4 animate-in fade-in zoom-in-95 duration-300">
                <div className="w-16 h-16 rounded-full bg-emerald-500/15 border-2 border-emerald-500 text-emerald-500 dark:text-emerald-400 flex items-center justify-center shadow-lg animate-bounce">
